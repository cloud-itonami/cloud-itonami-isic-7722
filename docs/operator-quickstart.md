# Operator Quickstart — Renting of video tapes and disks

Shortest path from clone to a verified local dry-run for **ISIC 7722** (`cloud-itonami-isic-7722`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7722.git
cd cloud-itonami-isic-7722
```
...
- Blueprint governor key: `video-rental-governor`
- Likely source path: `vidrentalops.governor.cljc`
